class BonusConfigBot1:
    ...
    txt = '''<b>🎁 Пополните баланс для размещения и получите билет мега лотереи</b>
...
2. Нажмите кнопку "Получить приз" в сообщении, которое придет после успешного пополнения'''
